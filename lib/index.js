...
Socket.prototype.bind = function (addr, callback) {
    nn.Bind(this.binding, addr, callback);
}
...
Socket.prototype.connect = function (addr, callback) {
    nn.Connect(this.binding, addr, callback);
}

Socket.prototype.connectSync = function (addr) {
